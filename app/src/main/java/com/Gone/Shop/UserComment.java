...
public class UserComment extends AppCompatActivity{
    ...
    public static List<UserCommentModel> postLists = new ArrayList<>();
    RecyclerView recyclerView;
    UserCommentAdapter postAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // setContentView(R.layout.activity_comment_box);
        ...
        postAdapter=new UserCommentAdapter(getApplicationContext(), postLists);
...
*/
        ...
        name.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(UserComment.this, MyProfileActivity.class);
    ...
    private void user_comment_submit(){
        ...
        if (user_comment.length()!=0){
            ...
            StringRequest sq = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ...
                    Toast.makeText(UserComment.this, "Your comment uploaded", Toast.LENGTH_LONG).show();
                    progressDialog.cancel();
                    startActivity(new Intent(UserComment.this,UserComment.class).addFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
                ...
                public void onErrorResponse(VolleyError error) {
                    Toast.makeText(UserComment.this,"Network connection failed!!!",Toast.LENGTH_LONG).show();
                    progressDialog.cancel();
            ...
            Toast.makeText(UserComment.this,"Please enter your comment",Toast.LENGTH_SHORT).show();
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        try {
                            ...
                            UserCommentModel postModel = new UserCommentModel();
