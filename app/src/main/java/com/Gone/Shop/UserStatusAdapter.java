...
public class UserStatusAdapter extends RecyclerView.Adapter<UserStatusAdapter.MyViewHolder> {
    ...
    private ArrayList<UserStatusModel> postLists;
    ...
    String email;
    String user_email;
    UserStatusModel newsModel;


    private static final String TAGG = UserStatusAdapter.class.getSimpleName();
    private SQLiteHandlerForUserStatus dbb;



    public UserStatusAdapter(Context context, List<UserStatusModel> postLists) {
        this.postLists = (ArrayList<UserStatusModel>)postLists;
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        final UserStatusModel newsModel = postLists.get(position);
        ...
        holder.btn_delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                delete_user_status(newsModel.getId());
            }
        });
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        ArrayList<UserStatusModel> postLists=new ArrayList<>();
        Context context;

        public MyViewHolder(View itemView, Context context, ArrayList<UserStatusModel> postLists) {
            super(itemView);
            this.context=context;
        ...
        public void onClick(View v) {
            ...
            UserStatusModel newsModel=this.postLists.get(position);
    ...
    void delete_user_status(final String pos){
        ...
        StringRequest sq = new StringRequest(Request.Method.POST, "http://172.245.177.162/~sabbirah/UniShop/delete_post.php", new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                finish();
                context.startActivity(new Intent(context,UserStatus.class).addFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
