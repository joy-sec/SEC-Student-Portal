...
public class AllCommentAdapter extends RecyclerView.Adapter<AllCommentAdapter.MyViewHolder> {
    ...
    private ArrayList<AllCommentModel> postLists;
    ...
    String email;
    String postID;
    public AllCommentAdapter(Context context, List<AllCommentModel> postLists) {
        this.postLists = (ArrayList<AllCommentModel>)postLists;
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        final AllCommentModel newsModel=postLists.get(position);
       ...
       // holder.location.setText(Html.fromHtml(newsModel.getLocation()));
        ...
        holder.btn_delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                delete_comment(newsModel.getId());
            }
        });
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        ArrayList<AllCommentModel> postLists=new ArrayList<>();
        Context context;
        ImageButton right,wrong;

        public MyViewHolder(View itemView, Context context, ArrayList<AllCommentModel> postLists) {
            super(itemView);
            this.context=context;
    ...
    void delete_comment(final String pos){
    ...
    void rating_user(final String id, final String user_email){
